...
class NatsSettings(BaseSettings):
    ...
    # CONSUMERS
    nats_consumer_notification_commands_send_email: str = Field(
        default="notification-service-commands-send-email",
        alias="NATS_CONSUMER_NOTIFICATION_COMMANDS_SEND_EMAIL",
    )
